...
#line 1 "/Users/nicholasho/Desktop/cleanedUpBLEDemo/BLEDemoClean/src/BLE_Clean.ino"

// Variables for keeping state
static void onDataReceived(const uint8_t* data, size_t len, const BlePeerDevice& peer, void* context);
void setup();
void loop();
#line 3 "/Users/nicholasho/Desktop/cleanedUpBLEDemo/BLEDemoClean/src/BLE_Clean.ino"
typedef struct {
  uint8_t light;
  uint8_t light2;
} led_level_t;
...
const char* blue        = "36f260de-0b93-4352-baa3-56b8be1e606a"; //blue char
